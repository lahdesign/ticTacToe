...
var userMoves = function userMoves(gameValues, gameOn) {
  return $.ajax({
    method: 'PATCH',
...
$(function () {
  $('.newGame').on('click', function () {
    ...
    create.createGame().then(function (data) {
...
var onchangePassword = function onchangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.changePasswordSuccess).catch(authUi.failure);
};
...
var onUserMoves = function onUserMoves(gameValues, data) {
  console.log('update moves ran');
  gameApi.updateMoves(gameValues, data.isOver).then(gameUi.userMovesSuccess).catch(gameUi.userMovesFailure);
};

module.exports = {
  onGetGames: onGetGames,
  onGameOver: onGameOver,
  onUserMoves: onUserMoves
...
var onUserMovesSuccess = function onUserMovesSuccess(data) {};
...
module.exports = {
  ...
  onUserMovesSuccess: onUserMovesSuccess,
...
var Game = function () {
  ...
  _createClass(Game, [{
    key: 'claim',
    value: function claim(event) {
      event.preventDefault();
      var available = this.checkIfAvailable(event.target.id);
      if (available === false) {
        return;
      }
      if (this.playerXTurn) {
      ...
      this.checkTie();
      this.checkIfWinner();
      gameApi.userMoves(gameValues, this.gameOn).then(console.log).catch(console.log);
    ...
    value: function playGame() {
      var bound = this.claim.bind(this);
      $('.gameButtons').click(bound);
    }
  }, {
    key: 'checkIfWinner',
    value: function checkIfWinner(playerXTurn, gameBoard) {
      var playerToken = this.playerXTurn ? 'x' : 'o';
      if (this.gameBoard[0] === playerToken && this.gameBoard[1] === playerToken && this.gameBoard[2] === playerToken || this.gameBoard[3] === playerToken && this.gameBoard[4] === playerToken && this.gameBoard[5] === playerToken || this.gameBoard[6] === playerToken && this.gameBoard[7] === playerToken && this.gameBoard[8] === playerToken || this.gameBoard[0] === playerToken && this.gameBoard[3] === playerToken && this.gameBoard[6] === playerToken || this.gameBoard[1] === playerToken && this.gameBoard[4] === playerToken && this.gameBoard[7] === playerToken || this.gameBoard[2] === playerToken && this.gameBoard[5] === playerToken && this.gameBoard[8] === playerToken || this.gameBoard[0] === playerToken && this.gameBoard[4] === playerToken && this.gameBoard[8] === playerToken || this.gameBoard[2] === playerToken && this.gameBoard[4] === playerToken && this.gameBoard[6] === playerToken) {
        this.endGame();
      } else {
        return;
      }
    ...
    value: function checkIfAvailable(index) {
...
module.exports = __webpack_require__.p + "b6b9e4ec83e27d1dbdf51be24e9e7cab.jpg";

/***/ }),
/* 25 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "cda4b8a7ef710b440a686941024d6e10.jpg";
